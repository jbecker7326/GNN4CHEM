...
%%%%%%%%%%%%%%%%%% Installation %%%%%%%%%%%%%%%%%%
Download the repository from the GitHub link: https://github.gatech.edu/wwang674/GNN4CHEM

To set up the environment, run:
conda env create -f environment.yml

Install PyTorch for you machine using the pip command specified at the following link:
https://pytorch.org/get-started/locally/

%%%%%%%%%%%%%%%%%% Quick-start guide to recreate data for the report %%%%%%%%%%%%%%%%%%
